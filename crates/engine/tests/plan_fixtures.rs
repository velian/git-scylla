...
use git_scylla_engine::{plan, resolve, Plan, PlanTemplate, Policy, RefAnswers, Selection};
...
fn finish(t: PlanTemplate, snaps: &[RepoSnapshot]) -> Plan {
    resolve(t, snaps, &RefAnswers::new())
}
